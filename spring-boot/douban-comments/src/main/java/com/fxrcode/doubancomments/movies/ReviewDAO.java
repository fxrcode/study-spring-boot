...
public class ReviewDAO {
    ...
    protected ReviewDAO(){}
    public ReviewDAO(String user_id, String user_name, int stars, LocalDate create_time, String short_review) {
    ...
    public String toString() {
        return String.format(
                "Review[user_id=%s, user=%s, stars=%d, time=%s, short_review=%s",
                user_id, user_name, stars, create_time, short_review
        );
    }
